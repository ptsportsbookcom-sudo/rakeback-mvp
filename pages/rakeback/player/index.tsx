...
export default function PlayerRakebackPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">My Rakeback</h1>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">My Rakeback</h1>
          <p className="mt-2 text-sm text-gray-600">View your rakeback earnings and claim rewards</p>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4 text-gray-900">Wager Summary</h3>
        ...
        {/* Rakeback Summary */}
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4 text-gray-900">Rakeback Summary</h3>
          ...
          {rakeback.accruedRakeback > 0 && (
            <button
              onClick={handleClaim}
              disabled={claiming}
              className="w-full bg-indigo-600 text-white px-4 py-3 rounded-md hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
            >
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between py-2 border-b">
              ...
              <span className="font-medium text-gray-900">
                ${(
                  (rakeback.casinoWager *
                    rakeback.effectiveHouseEdge *
